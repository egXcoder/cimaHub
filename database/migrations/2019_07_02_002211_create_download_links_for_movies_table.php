...
class CreateDownloadLinksForMoviesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('download_links_movies', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('download_links_movies');
    }
}
